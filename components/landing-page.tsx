...
const REVIEWS = [
  ...
  { name: "윤O님", service: "Real Success", persona: "타 금융업 재직 · 커리어 전환", text: "타 금융업계 재직자로 부동산 금융 진입을 검토하며 이용했는데, 직장인에게도 정말 값진 시간이었습니다. 멘토 B님께서 제 입장에서 진심으로 공감하며 커리어 로드맵을 프로페셔널하게 설계해주셨고, 어떤 준비를 해야 할지 구체적인 계획까지 함께 고민해주셨습니다. 현업 전문가의 깊이 있는 지식과 경험 덕분에 지름길을 찾은 듯 든든했습니다." },
