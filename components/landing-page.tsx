...
const REVIEWS = [
  { name: "김O님", service: "Real Bridge", persona: "신입 · 면접 준비", text: "자소서를 기반으로 한 면접 준비 도움을 받았는데, 제가 뭐가 부족하고 뭘 보완해야 할지 명확히 알게 되어 정말 값진 시간이었습니다. 앞으로의 방향성을 설정하는 데도 큰 도움을 받았습니다. 감사합니다!" },
  { name: "이O님", service: "Real Bridge", persona: "신입 · 자소서", text: "객관적으로 보지 못했던 제 자소서의 문제점을 일목요연하게 정리해주셨습니다. 가려웠던 부분들도 정확하게 캐치해서 답변해주시고, 제가 하고 싶었던 업무를 취준생 입장에서 듣기 편하게 설명해주셨어요. 1회를 등록했지만 꿈을 이루기 위해 추가로 더 등록하려 합니다. 함께라면 목표를 달성할 것 같은 느낌이 강하게 듭니다." },
  { name: "박O님", service: "Real Bridge", persona: "신입 · 진로 방향", text: "공채가 뜰 때마다 '일단 무작정 다 지원하자'는 막연한 마음이었는데, 컨설팅을 통해 제게 맞는 직무와 진로 방향을 구체적으로 잡을 수 있었습니다. 특히 자기소개서를 어떻게 작성해야 할지 명확히 보이기 시작했습니다. 정말 감사드립니다!" },
  { name: "최O님", service: "Real Bridge", persona: "신입 · 면접 대비", text: "코멘트 주신 부분이 면접에서 많이 도움이 되었습니다. 멘토님께서 업계 용어(GP, LP 개념)를 알려주셔서 관심 어필을 할 수 있었어요. 촉박한 일정에도 현업에 계신 분들을 빠르게 연결해주시고 대응도 빨라서 준비 과정에 큰 도움이 됐습니다. 감사드려요!" },
  { name: "정O님", service: "Real Success", persona: "중고신입 · 직무 이해", text: "현업 중심의 내용으로 구성되어 실질적인 도움이 됐습니다. 이론적 조언에 그치지 않고 실제 실무 사례를 바탕으로 설명해주어 업무 흐름과 역할을 명확히 이해할 수 있었고, 자기소개서와 경력기술서를 구조적으로 검토해주신 점이 인상 깊었습니다. 단어를 바꾸는 수준을 넘어 전체 맥락과 메시지를 직무와 연결해 피드백해주셨어요." },
  { name: "강O님", service: "Real Success", persona: "신입 · 자소서 방향", text: "다소 폐쇄적인 분야라 혼자 준비하며 스스로도 두루뭉술하다고 생각했는데, 1차 멘토링 피드백을 통해 제 경험·성격·관심사를 기반으로 자소서를 어떤 방향으로 써야 할지 파악할 수 있어 만족스러웠습니다. 멘토분들께서 앞으로의 계획과 현업 이야기도 해주셔서 큰 도움이 됐습니다." },
  { name: "윤O님", service: "Real Bridge", persona: "타 금융업 재직 · 커리어 전환", text: "타 금융업계 재직자로 부동산 금융 진입을 검토하며 이용했는데, 직장인에게도 정말 값진 시간이었습니다. 멘토 B님께서 제 입장에서 진심으로 공감하며 커리어 로드맵을 프로페셔널하게 설계해주셨고, 어떤 준비를 해야 할지 구체적인 계획까지 함께 고민해주셨습니다. 현업 전문가의 깊이 있는 지식과 경험 덕분에 지름길을 찾은 듯 든든했습니다." },
  { name: "임O님", service: "Real Success", persona: "경력 · 직종 전환", text: "늦은 나이에 직종을 전환하게 되어 나이 때문에 서류 탈락하지 않을까 불안했지만, 멘토님을 만나면서 처음으로 서류에 합격했습니다. 제 경험과 성격을 지원 직무에 맞게 방향을 잡아주시고 어필 포인트를 극대화해 자소서를 꼼꼼히 첨삭해주셨고, 면접 준비 때 예상 질문과 팁도 상세히 알려주셨습니다. 부담되는 금액일 수 있지만 그 이상의 가치를 하는 컨설팅입니다." },
  { name: "한O님", service: "Real Success", persona: "신입 · 자소서·경력기술서", text: "부동산 취업을 준비하며 받은 컨설팅은 현업 중심이라 실질적인 도움이 됐습니다. 실제 실무 사례를 바탕으로 설명해주어 업무 흐름과 역할을 명확히 이해할 수 있었고, 특히 자기소개서와 경력기술서를 구조적으로 검토해주신 점이 인상 깊었습니다. 제 강점과 개선점을 스스로 점검하며 함께 정리해가는 과정이 좋았습니다." },
];
